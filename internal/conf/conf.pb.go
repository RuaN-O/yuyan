...
type Jwt struct {
	...
	Refresh       *durationpb.Duration   `protobuf:"bytes,3,opt,name=refresh,proto3" json:"refresh,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *Jwt) GetRefresh() *durationpb.Duration {
	if x != nil {
		return x.Refresh
	}
	return nil
...
const file_internal_conf_conf_proto_rawDesc = "" +
	...
	"\x03Jwt\x12\x16\n" +
	"\x06secret\x18\x01 \x01(\tR\x06secret\x121\n" +
	"\x06expire\x18\x02 \x01(\v2\x19.google.protobuf.DurationR\x06expire\x123\n" +
	"\arefresh\x18\x03 \x01(\v2\x19.google.protobuf.DurationR\arefreshB\x1aZ\x18yuyan/internal/conf;confb\x06proto3"
...
var file_internal_conf_conf_proto_depIdxs = []int32{
	...
	7,  // 7: kratos.api.Jwt.refresh:type_name -> google.protobuf.Duration
	7,  // 8: kratos.api.Server.HTTP.timeout:type_name -> google.protobuf.Duration
	7,  // 9: kratos.api.Server.GRPC.timeout:type_name -> google.protobuf.Duration
